# flake8: noqa
"""
Django settings for datahausproject project.
...
DJANGO_ROOT = root.path('datahausproject')
...
ROOT_URLCONF = 'datahausproject.urls'

#Admins see https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = (
    ("""Daniel Cagney""", '121707785@umail.ucc.ie'),
)
...
WSGI_APPLICATION = 'datahausproject.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///datahausproject'),
}
...
WAGTAIL_SITE_NAME = "datahausproject"
